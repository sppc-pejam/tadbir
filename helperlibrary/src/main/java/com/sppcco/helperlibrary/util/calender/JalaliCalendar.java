...
public class JalaliCalendar extends Calendar {
    ...
    public static String getGregorianDate(@NonNull String jalaliDate) {
        String[] arr;

        if(jalaliDate.contains("-"))
            arr = jalaliDate.split("-");
        else
            arr = jalaliDate.split("/");
        ...
        mYear = gDate.getYear();
        mMonth = gDate.getMonth();
        mDay = gDate.getDate();
        String sDate = mYear + (mMonth >= 10 ? "-" : "-0") + (mMonth + 1) + (mDay >= 10 ? "-" : "-0") + mDay;
        //------------------------------
        //cal.clear();
    ...
    public static String getJalaliDate(Date gDate) {
        ...
        String jalali = jDate.year
                + (jDate.month >= 10 ? "/" : "/0") + (jDate.month + 1)
                + (jDate.date >= 10 ? "/" : "/0") + jDate.date;


        return jalali;
        /*return jalali.replaceAll("0", "").replaceAll("1", "").replaceAll("2", "")
